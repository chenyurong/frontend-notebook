...
- [HTML 标签](#html-%E6%A0%87%E7%AD%BE)
  - [文档章节标签](#%E6%96%87%E6%A1%A3%E7%AB%A0%E8%8A%82%E6%A0%87%E7%AD%BE)
  - [列表标签](#%E5%88%97%E8%A1%A8%E6%A0%87%E7%AD%BE)
  - [表格](#%E8%A1%A8%E6%A0%BC)
  - [表单](#%E8%A1%A8%E5%8D%95)
  - [引用标签](#%E5%BC%95%E7%94%A8%E6%A0%87%E7%AD%BE)
  - [链接标签](#%E9%93%BE%E6%8E%A5%E6%A0%87%E7%AD%BE)
  - [格式化标签](#%E6%A0%BC%E5%BC%8F%E5%8C%96%E6%A0%87%E7%AD%BE)
  - [强调标签](#%E5%BC%BA%E8%B0%83%E6%A0%87%E7%AD%BE)
  - [换行标签](#%E6%8D%A2%E8%A1%8C%E6%A0%87%E7%AD%BE)
  - [嵌入标签](#%E5%B5%8C%E5%85%A5%E6%A0%87%E7%AD%BE)
...
NOTE: `<dl>` 为自定义列表，其中一个`<dl>`可以对应一个或多个 `<dt>`，一个`<dt>`可以对应多个`<dd>`，并且`dt` 与 `dl`列表会有缩进的效果。
...
使用 `colspan` 属性进行跨列，使用 `rowspan` 属性进行跨行。
...
- `<blockquote>` 引用大块文字
- `<pre>` 保存格式化的内容，一般用于引用代码（其空格、换行等格式不会丢失）
...
NOTE：`<pre>` 会保留换行和空格，通常与 `<code>` 一同使用。
